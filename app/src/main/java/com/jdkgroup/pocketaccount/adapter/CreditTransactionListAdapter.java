...
public class CreditTransactionListAdapter extends RecyclerView.Adapter<CreditTransactionListAdapter.ViewHolder> {
    ...
    public CreditTransactionListAdapter(Activity activity, List<ModelTransaction> alTransaction) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.itemview_credit_transaction_list, parent, false));
    }
